...
public class Horoscopes {
	...
	public static void main(String[] args) {
		...
		if (star.equalsIgnoreCase("gemini")) {
			JOptionPane.showMessageDialog(null, "your star sign is 2 people shaking hands");
		...
		if (star.equalsIgnoreCase("cancer")) {
			JOptionPane.showMessageDialog(null, "your star sign is a crab looking thingy");
		...
		if (star.equalsIgnoreCase("leo")) {
			JOptionPane.showMessageDialog(null, "your star sign is a lion looking thingy");
		...
		if (star.equalsIgnoreCase("virgo")) {
			...
			JOptionPane.showMessageDialog(null, "your star sign is a person holding a flower or something like that");
		...
		if (star.equalsIgnoreCase("libra")) {
			JOptionPane.showMessageDialog(null, "your star sign is a scale thingy");
		...
		if (star.equalsIgnoreCase("scorpio")) {
			JOptionPane.showMessageDialog(null, "your star sign is a lobster looking thing");
